...
## Team dynamics
- See `work/team.md` — working style archetypes (David, Tom, Alex) and how they fit together
...
## Work philosophy
See `growth/insights.md` → "Work & achievement" for full context. Core: work from strategy not fear; rest = investing in personal life.
